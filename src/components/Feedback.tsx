...
const Feedback = () => {
  ...
  return (
    <>
      <section id="Feedback" className="flex justify-center bg-dark px-4 py-8 text-white lg:py-16">
        <div className="container">
          <div>
            <span className="text-xl text-blue_light lg:ml-[0.17rem]">Клиенты</span>
